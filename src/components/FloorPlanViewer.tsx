  ...
  return (
    <>
      <button
        ...
        className="block h-[min(48vh,560px)] min-h-[320px] w-full max-w-[760px] overflow-hidden rounded-card border p-3 transition-colors duration-300 ease-editorial hover:border-brass sm:p-4"
